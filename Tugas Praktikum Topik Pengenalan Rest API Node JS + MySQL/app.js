...
app.post("/sewa", (req,res) => {
    ...
    db.query(sql, data, (error, result) => {
        ...
        if (error) {
            ...
            res.json({message: "Data SEWA has been inserted"})
        }
    })
})
...
app.get("/sewa", (req,res) => {
    // create sql query
    let sql = "select s.id_sewa, m.id_mobil, m.nomor_mobil, m.merk, m.jenis, m.warna, k.id_karyawan, k.nama_karyawan, p.id_pelanggan, p.nama_pelanggan, s.tgl_sewa, s.tgl_kembali, s.total_bayar " + "from sewa s join mobil m on s.id_mobil = m.id_mobil " + 
...
app.delete("/sewa/:id_sewa", (req, res) => {
    ...
    db.query(sql, param, (error, result) => {
        if (error) {
            ...
            res.json({message: "Data SEWA has been deleted"})
        }
    })
